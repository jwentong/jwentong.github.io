...
{: .text-justify}
My research focuses on LLM-based AI Agent and Multi-Armed Bandit (MAB), with applications in wireless communications. I am broadly interested in building learning systems that make sequential decisions under uncertainty, efficiently explore large action spaces, and achieve robust performance in real-world networked environments.
...
{: .text-justify}
- [09/2026] We are going to hold the 4rd 6G wireless summit in Hong Kong on Dec. 3-4,  "[IEEE Hong Kong 6G Wireless Summit (IEEE HK6GWS 2026)](https://hk6gws2026.ieee-hk6gws.org/)". Warmly Welcome!
- [09/2026] We have launched WirelessAgent. You can try it on our website. [Try](https://wirelessagent.plus/)!
...
- [06/2026] One of our papers, "*Bridging Visual and Wireless Sensing via a Unified Radiation Field for 3D Radio Map Construction*," has been accepted by npj Wireless Technology. Congrats to Chaozhen! [Paper](https://www.nature.com/articles/s44459-026-00067-6).
